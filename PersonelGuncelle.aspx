<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonelGuncelle.aspx.cs" Inherits="PTS2.PersonelGüncelle" %>
            ...
            <div class="col-md-6 col-md-offset-3">
                <table class="kendiyazdigimCSS">
                    ...
                    <asp:Panel ID="pnlRol" runat="server" Visible="false">
                        <tr>
                            <td style="width: 25%">Adminlik Özelliği :</td>
                            <td>
                  
                                <asp:LinkButton ID="lbAdminlik" CommandName="Onayla" runat="server" OnClick="lbAdminlik_Click" CommandArgument='<%#Eval("personelID") %>'><span id="spanOnayla" runat="server" class="glyphicon glyphicon-ok-circle"></span>Onayla</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>Rol:</td>
                    ...
                    <asp:Panel ID="pnlSifreGorunurluk" runat="server" Visible="false">
                        <tr>
                            <td>Eski Şifre:</td>
                            <td>
                                <asp:TextBox ID="TxtboxEskiSifreGuncelle" CssClass="form-control" placeholder="Eski Şifrenizi Giriniz" runat="server" Width="235px" TextMode="Password" required />
                            </td>
                        </tr>
                        <tr>
                            <td>Yeni Şifre:</td>
                            <td>
                                <asp:TextBox ID="tbYeniSifreGuncelle" TextMode="Password" CssClass="form-control" placeholder="Yeni Şifrenizi Giriniz " runat="server" Width="235px" />
                            </td>
                        </tr>
                        <tr>
                            <td>Tekrar Yeni Şifre:</td>
                            <td>
                                <asp:TextBox ID="tbTekrarYeniSifreGuncelle" TextMode="Password" CssClass="form-control" placeholder="Tekrar Yeni Şifrenizi Giriniz" runat="server" Width="235px" />
                            </td>
                        </tr>
                    </asp:Panel>
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 48%">
                                        <asp:DropDownList ID="ddlEmailGuncelleProviders" runat="server" AppendDataBoundItems="true" CssClass="form-control" required>
                                            ...
                                            <asp:ListItem Text="ogr.dpu.edu.tr" Value="2"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnSifreGonder" Visible="false" runat="server" CssClass="btn btn-info" Text="Şifre Gönder" OnClick="btnSifreGonder_Click" />
